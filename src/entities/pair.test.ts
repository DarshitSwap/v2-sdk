...
import { ChainId, CurrencyAmount, Price, Token, V2_FACTORY_ADDRESSES, WETH9 } from 'darshitswap-sdk-core'
...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0x29FA05250D62347725320Fe4d7036f7Bb6284e97')
  })
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0xDD01e7Bf45200a9d7FF4f9cEB26e6dB79b9C72dC')
    })
